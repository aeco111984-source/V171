// Currency Exchange V17 — Solar Theme (Pure HTML/CSS/JS)
// XE-style converter perfection, trust surface 2.0, providers live re-rank,
// quick chips + slider, sparkline + fair meter, tabs (providers/tools/guidance),
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function drawSpark(canvas, series){
    ...
    ctx.lineWidth = 2; ctx.strokeStyle = "#c99a2e"; /* gold */
    ctx.beginPath();
    series.forEach((v,i)=>{
      const x = i*xStep;
  ...
  // Filter by speed
  if (speedFilter){ speedFilter.addEventListener("change", compute); }
